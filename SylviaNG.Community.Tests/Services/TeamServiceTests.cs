...
public class TeamServiceTests
{
    ...
    public TeamServiceTests()
    {
        ...
        _service = new TeamService(_teamRepositoryMock.Object, _teamMemberRepositoryMock.Object, _unitOfWorkMock.Object);
    }
    ...
    public async System.Threading.Tasks.Task AddMemberAsync_WhenAlreadyMember_ShouldThrowDuplicateException()
    {
        ...
        // Act
        var act = () => _service.AddMemberAsync(1, new TeamMemberAddRequest { EmployeeId = 5 });
    ...
    public async System.Threading.Tasks.Task RemoveMemberAsync_WhenMemberExists_ShouldSetIsActiveFalse()
    {
        ...
        // Act
        await _service.RemoveMemberAsync(1, 5);
